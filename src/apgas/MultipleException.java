...
/**
 * A {@link MultipleException} is thrown by the {@code finish} construct upon termination when the
 * code or tasks in its scope have uncaught exceptions. The uncaught exceptions may be retrieved
 * using the {@link #getSuppressed()} method of this {@link MultipleException}.
 */
public class MultipleException extends RuntimeException {
  ...
  /**
   * Constructs a new {@link MultipleException} from the specified {@code exceptions}.
   *
  ...
  /**
   * Makes a new {@link MultipleException} from the specified {@code exceptions} with a type
   * reflecting the contained dead place exceptions.
   *
   * @param exceptions the uncaught exceptions that contributed to this {@code MultipleException}
